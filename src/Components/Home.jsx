      ...
      <div className="title">
        ...
        <hr />
          <div className="dropdown-items">
           <label>Unit<a data-tooltip-id="my-tooltip4"><FcInfo /></a>
              <Tooltip id="my-tooltip4" style={{ backgroundColor: "rgb(240, 240, 240)", color: "#222"}}><div>
                 <h6>Tank calculation unit</h6><hr />
                 <p> A unit may also mean the standard <br/>units used for measurement.For<br />Ex.feet/unit & meter/cm.</p></div></Tooltip></label>
           <select value={unit} onChange={handleUnitChange}>
            <option value="Meter/CM">Meter/CM</option>
            <option value="Feet/Inch">Feet/Inch</option></select>
            </div>
            <div className="field-items">
              <label>Length<a data-tooltip-id="my-tooltip1"><FcInfo /></a>
              <Tooltip id="my-tooltip1" style={{ backgroundColor: "rgb(240, 240, 240)", color: "#222"}}><div>
              <h6>What is length in tank calculation?</h6><hr />
              <p>Length is the term used for identifying<br />the size of an object or distance.</p></div></Tooltip></label>
              ...
              <label>Width<a data-tooltip-id="my-tooltip2"><FcInfo /></a>
              <Tooltip id="my-tooltip2" style={{ backgroundColor: "rgb(240, 240, 240)", color: "#222"}}><div>
                 <h6>What is width in tank calculation?</h6><hr />
                 <p>Width is a measurement of how far<br />across a three dimensional object is.</p></div></Tooltip></label>
              <Input type="Number" value={width} onChange={(e) => setWidth(e.target.value)}/>
              <button>{unit ==='Meter/CM'? 'meter': 'feet'}</button>
              <Input type="Number" value={widthOn} onChange={(e) => setWidthOn(e.target.value)}/>
              <button>{unit ==='Meter/CM'? 'cm': 'inch'}</button>
              <label>Depth <a data-tooltip-id="my-tooltip3"><FcInfo /></a>
              <Tooltip id="my-tooltip3" style={{ backgroundColor: "rgb(240, 240, 240)", color: "#222"}}><div>
                 <h6>What is depth in tank calculation?</h6><hr />
                 <p>Depth is a measurement of how far<br /> back a three dimensional object is.</p></div></Tooltip></label>
        ...
        <div className="head">
          ...
          {unit === 'Feet/Inch' && (
          <div className="Volume-value">
            <p1>{totalQuantity.toFixed(2)} lt</p1>
            <hr/>
            <p2>Volume = {(totalVolume/35.3147).toFixed(2)} m³ | {totalVolume.toFixed(2)} ft³</p2>
            <hr />
            <h6> Water-sump/Tank Calculation</h6>
            <p>Total Volume = Length x Width X Depth </p>
            <p>Total Volume = {lengthIn} x {widthIn} x {depthIn}</p>
